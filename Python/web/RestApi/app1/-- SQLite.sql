...
-- 4.HAVING из агригированных записей, выибираютсе подходящие под условие
-- 5.SELECT формируются рузультатирующи данные как они указаны в селект
